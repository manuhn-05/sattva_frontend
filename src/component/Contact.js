            ...
            <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="contact">
                <div className="container">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        <h6 className="text-green-600 text-base font-medium uppercase mb-2">Contact us</h6>
                        <h3 className="mb-4 md:text-2xl text-xl font-medium dark:text-white">Get In Touch !</h3>

                        {/* <p className="text-slate-500 dark:text-slate-300 max-w-xl mx-auto">Launch your campaign and benefit from our expertise on designing and managing conversion centered Tailwind CSS html page.</p> */}
                    </div>
                        ...
                        <div className="lg:col-span-8">
                            <div className="p-6 rounded-md shadow bg-white dark:bg-slate-900">
                                <form>
                                    ...
                                    <button type="submit" id="submit" name="send" className="btn bg-blue-600 hover:bg-blue-700 border-blue-600 hover:border-blue-700 text-white rounded-md h-11 justify-center flex items-center">Send Message</button>
                                </form>
                            </div>
                        </div>
                            ...
                            <div className="lg:ms-8">
                                <div className="flex">
                                    ...
                                    <div className="flex-1 ms-6">
                                        ...
                                        <a href="tel:+152534-468-854" className="text-slate-500">+152 534-468-854</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex mt-4">
                                    ...
                                    <div className="flex-1 ms-6">
                                        ...
                                        <a href="mailto:contact@example.com" className="text-slate-500">contact@example.com</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex mt-4">
                                    ...
                                    <div className="flex-1 ms-6">
                                        ...
                                        <p className="text-slate-500 mb-2">C/54 Northwest Freeway, Suite 558, Houston, USA 485</p>
                                    </div>
                                </div>
                            </div>
                        </div>
