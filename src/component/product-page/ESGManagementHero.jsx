...
const ESGManagementHero = () => {
  ...
  return (
    <article className={`md:h-[calc(100vh-250px)] lg:min-h-[calc(100vh-1200px)] flex flex-col items-center p-4 md:py-32 max-md:pt-[12%]
      ...
      <section className={`container grid grid-cols-1 md:grid-cols-[60%_40%] gap-[2%]`}>
        <div className="text-left md:text-center">
          <h6 className="text-green-600 text-[0.7em] lg:text-base font-medium uppercase mb-2">ESG management is now easier than ever</h6>
      <div className='text-[0.45em] md:text-[0.75em] lg:text-[0.5em]'>
      <p className={`text-justify text-slate-500 dark:text-white/70 `}>
          ...
          <h6 className='text-[1.2em] lg:text-[1em] font-bold dark:text-white text-left my-[2%]'>Key Capabilities</h6>
          <ul className='list-disc list-inside text-left leading-7 lg:leading-9 text-slate-500 dark:text-white/70'>
            {
