...
const ESGManagementHero = () => {
  ...
  return (
    <article className={`md:h-[calc(100vh-250px)] lg:min-h-[calc(100vh-100px)] flex flex-col items-center p-4 md:py-32 max-md:pt-[12%]
      ...
      <div className='text-[0.45em] md:text-[0.75em] lg:text-[0.45em]'>
      <p className={`text-justify `}>
          ...
          <ul className='list-disc list-inside text-left leading-7 lg:leading-9'>
            {
