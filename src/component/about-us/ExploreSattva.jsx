...
const ExploreSattva = () => {
    return (
        <article className='md:min-h-[calc(100vh-200px)] flex flex-col items-center p-4 md:py-32 dark:bg-slate-800'>
            <section className={`bg-[#082561] text-white lg:w-[65%] flex h-[40vh] md:h-[calc(100vh-200px)] items-center justify-center px-4 rounded-lg `}>
